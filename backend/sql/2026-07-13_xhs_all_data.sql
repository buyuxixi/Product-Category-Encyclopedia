...
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '用理疗灯是为了烤走疼痛，而不是烤来伤害', NULL, 'https://www.xiaohongshu.com/explore/69b90da9000000001a031bfe', '[小雪] | ❤ 5855 | 💬 104 | ⭐ 70 | 搜索词: 红外灯烫伤', NULL, 51.27, 1, '2026-07-13 08:36:37'
...
INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '理疗灯乱象', NULL, 'https://www.xiaohongshu.com/explore/6981b6d40000000028023170', '[追光闪闪] | ❤ 2712 | 💬 124 | ⭐ 2055 | 搜索词: 红外照了没用', NULL, 65.21, 1, '2026-07-13 08:36:37'
FROM categories c WHERE c.code = 'FAR_INFRARED'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/6981b6d40000000028023170');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '热门理疗灯二选一', NULL, 'https://www.xiaohongshu.com/explore/6a26bf1f000000001503c0ef', '[爱分享] | ❤ 2389 | 💬 23 | ⭐ 2541 | 搜索词: 红外理疗灯', NULL, 56.19, 1, '2026-07-13 08:36:37'
FROM categories c WHERE c.code = 'FAR_INFRARED'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/6a26bf1f000000001503c0ef');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '照红光没效果？甚至还反黑？真相在这！', NULL, 'https://www.xiaohongshu.com/explore/694ca152000000001e02a628', '[Hooyaa（修屏障版）] | ❤ 2410 | 💬 41 | ⭐ 1584 | 搜索词: 红外照了没用', NULL, 48.0, 0, '2026-07-13 08:36:37'
FROM categories c WHERE c.code = 'FAR_INFRARED'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/694ca152000000001e02a628');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '痛经女孩都去照这个红外线理疗灯', NULL, 'https://www.xiaohongshu.com/explore/6a09996b0000000007012805', '[木子] | ❤ 1885 | 💬 379 | ⭐ 756 | 搜索词: 红外理疗灯', NULL, 48.3, 0, '2026-07-13 08:36:37'
FROM categories c WHERE c.code = 'FAR_INFRARED'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/6a09996b0000000007012805');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '安利给所有女生！红外线理疗灯yyds！', NULL, 'https://www.xiaohongshu.com/explore/62da76f2000000000d0240d8', '[躺平发发淇🌸] | ❤ 1770 | 💬 139 | ⭐ 1335 | 搜索词: 红外理疗灯', NULL, 48.29, 0, '2026-07-13 08:36:37'
FROM categories c WHERE c.code = 'FAR_INFRARED'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/62da76f2000000000d0240d8');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '一篇说清楚电烤灯红外线理疗器怎么选', NULL, 'https://www.xiaohongshu.com/explore/68cbb528000000001203259c', '[儿女双全] | ❤ 1509 | 💬 304 | ⭐ 905 | 搜索词: 理疗灯辐射', NULL, 46.4, 0, '2026-07-13 08:36:37'
FROM categories c WHERE c.code = 'FAR_INFRARED'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/68cbb528000000001203259c');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '理疗灯治疗妇科炎症2', NULL, 'https://www.xiaohongshu.com/explore/6232b04a0000000001025645', '[草莓来养生] | ❤ 1404 | 💬 200 | ⭐ 1108 | 搜索词: 理疗灯辐射', NULL, 47.89, 0, '2026-07-13 08:36:37'
FROM categories c WHERE c.code = 'FAR_INFRARED'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/6232b04a0000000001025645');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '哈！30几岁用上了远红外烤灯', NULL, 'https://www.xiaohongshu.com/explore/67e6a6750000000009015c3f', '[体子] | ❤ 894 | 💬 285 | ⭐ 671 | 搜索词: 红外灯关节', NULL, 37.33, 0, '2026-07-13 08:36:37'
FROM categories c WHERE c.code = 'FAR_INFRARED'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/67e6a6750000000009015c3f');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '分享丨红外理疗灯是智商税，我为什么会买？', NULL, 'https://www.xiaohongshu.com/explore/67efab86000000001c0280fa', '[阿蕊碎碎念] | ❤ 935 | 💬 361 | ⭐ 381 | 搜索词: 红外理疗灯', NULL, 34.11, 0, '2026-07-13 08:36:37'
FROM categories c WHERE c.code = 'FAR_INFRARED'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/67efab86000000001c0280fa');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '我不在你身边 希望这个小药盒照顾好你', NULL, 'https://www.xiaohongshu.com/explore/66d02674000000001d01561e', '[糕手茶茶] | ❤ 23932 | 💬 609 | ⭐ 5195 | 搜索词: 药盒便携', NULL, 90.0, 1, '2026-07-13 08:36:37'
...
INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '分享好物～小米药盒', NULL, 'https://www.xiaohongshu.com/explore/6201e4b60000000001027ed9', '[粉粉熊和公仔面] | ❤ 4294 | 💬 97 | ⭐ 2512 | 搜索词: 药盒提醒', NULL, 79.7, 1, '2026-07-13 08:36:37'
FROM categories c WHERE c.code = 'MEDICATION_MANAGEMENT'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/6201e4b60000000001027ed9');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '服务设计 ｜ 老年人便捷式药盒设计', NULL, 'https://www.xiaohongshu.com/explore/6672fffa000000000e033f17', '[Moon] | ❤ 3690 | 💬 70 | ⭐ 2145 | 搜索词: 智能药盒', NULL, 70.71, 1, '2026-07-13 08:36:37'
FROM categories c WHERE c.code = 'MEDICATION_MANAGEMENT'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/6672fffa000000000e033f17');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '我的天，以后吃药也太方便了吧😭', NULL, 'https://www.xiaohongshu.com/explore/69cf834000000000230243a3', '[CreaTide创意潮汐] | ❤ 4614 | 💬 272 | ⭐ 796 | 搜索词: 药盒', NULL, 69.95, 1, '2026-07-13 08:36:37'
FROM categories c WHERE c.code = 'MEDICATION_MANAGEMENT'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/69cf834000000000230243a3');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '这些看似智商税，实则嘎嘎好用的吃药辅助器', NULL, 'https://www.xiaohongshu.com/explore/677b509f000000000b00c180', '[王一伯] | ❤ 2733 | 💬 196 | ⭐ 2700 | 搜索词: 切药器', NULL, 76.93, 1, '2026-07-13 08:36:37'
FROM categories c WHERE c.code = 'MEDICATION_MANAGEMENT'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/677b509f000000000b00c180');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '谁家的小宝宝还不好好吃药阿？', NULL, 'https://www.xiaohongshu.com/explore/64bfd63d0000000010033361', '[美念念] | ❤ 3802 | 💬 16 | ⭐ 1037 | 搜索词: 切药器儿童', NULL, 52.58, 1, '2026-07-13 08:36:37'
FROM categories c WHERE c.code = 'MEDICATION_MANAGEMENT'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/64bfd63d0000000010033361');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '这个设计真的会防止忘吃药！', NULL, 'https://www.xiaohongshu.com/explore/68b07c15000000001d02a59b', '[虚构远方] | ❤ 1362 | 💬 472 | ⭐ 234 | 搜索词: 药盒忘记吃药', NULL, 36.55, 0, '2026-07-13 08:36:37'
FROM categories c WHERE c.code = 'MEDICATION_MANAGEMENT'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/68b07c15000000001d02a59b');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '小心小心小心使用分药器！', NULL, 'https://www.xiaohongshu.com/explore/68e25c8c0000000004011810', '[水沉] | ❤ 1906 | 💬 232 | ⭐ 129 | 搜索词: 切药器', NULL, 40.67, 0, '2026-07-13 08:36:37'
FROM categories c WHERE c.code = 'MEDICATION_MANAGEMENT'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/68e25c8c0000000004011810');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '小华同学的随身小药盒有解酒药哈哈哈哈', NULL, 'https://www.xiaohongshu.com/explore/679774fb0000000029038259', '[老板爹和少爷叔的金刚球] | ❤ 2026 | 💬 32 | ⭐ 214 | 搜索词: 药盒便携', NULL, 26.14, 0, '2026-07-13 08:36:37'
FROM categories c WHERE c.code = 'MEDICATION_MANAGEMENT'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/679774fb0000000029038259');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '送给男朋友的爱心小药盒呀～', NULL, 'https://www.xiaohongshu.com/explore/67bf2b6e000000002503d868', '[小八] | ❤ 1360 | 💬 25 | ⭐ 633 | 搜索词: 药盒便携', NULL, 24.01, 0, '2026-07-13 08:36:37'
FROM categories c WHERE c.code = 'MEDICATION_MANAGEMENT'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/67bf2b6e000000002503d868');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '建议大家卧室都放一根便宜不占地的落地棒灯', NULL, 'https://www.xiaohongshu.com/explore/68ca5846000000001302b0ac', '[少点虚荣来点gravel] | ❤ 11863 | 💬 584 | ⭐ 8457 | 搜索词: 智能夜灯', NULL, 90.0, 1, '2026-07-13 08:36:37'
...
INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '等我把星空灯的雷都踩完了  你们再来！', NULL, 'https://www.xiaohongshu.com/explore/69ef6b3a00000000200386a2', '[小陈的神经世界] | ❤ 1194 | 💬 35 | ⭐ 568 | 搜索词: 智能夜灯', NULL, 22.54, 0, '2026-07-13 08:36:37'
FROM categories c WHERE c.code = 'NIGHT_LIGHT'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/69ef6b3a00000000200386a2');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '啊啊啊！9r的小夜灯也太美了！', NULL, 'https://www.xiaohongshu.com/explore/6825f38c000000002300d8fd', '[猪猪小洛] | ❤ 740 | 💬 12 | ⭐ 278 | 搜索词: 智能夜灯', NULL, 12.07, 0, '2026-07-13 08:36:37'
FROM categories c WHERE c.code = 'NIGHT_LIGHT'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/6825f38c000000002300d8fd');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '米家夜灯3', NULL, 'https://www.xiaohongshu.com/explore/678cd4dc000000001602a8c3', '[力大如5] | ❤ 612 | 💬 50 | ⭐ 208 | 搜索词: 智能夜灯', NULL, 13.72, 0, '2026-07-13 08:36:37'
FROM categories c WHERE c.code = 'NIGHT_LIGHT'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/678cd4dc000000001602a8c3');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '装灯带原来还有这样的坑😂', NULL, 'https://www.xiaohongshu.com/explore/68e22ef00000000005032137', '[年纪轻轻就有猫了（选软装中）] | ❤ 265 | 💬 54 | ⭐ 149 | 搜索词: 智能灯被坑', NULL, 9.91, 0, '2026-07-13 08:36:37'
FROM categories c WHERE c.code = 'NIGHT_LIGHT'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/68e22ef00000000005032137');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '灯带智能模块避坑', NULL, 'https://www.xiaohongshu.com/explore/664ec8af0000000014018b5b', '[Keiro] | ❤ 117 | 💬 115 | ⭐ 172 | 搜索词: 智能灯被坑', NULL, 14.82, 0, '2026-07-13 08:36:37'
FROM categories c WHERE c.code = 'NIGHT_LIGHT'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/664ec8af0000000014018b5b');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '避坑！欧普智能灯无法连接米家！！', NULL, 'https://www.xiaohongshu.com/explore/68948de9000000002203804a', '[momo] | ❤ 69 | 💬 84 | ⭐ 57 | 搜索词: 智能灯被坑', NULL, 9.8, 0, '2026-07-13 08:36:37'
FROM categories c WHERE c.code = 'NIGHT_LIGHT'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/68948de9000000002203804a');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '智能灯踩坑……', NULL, 'https://www.xiaohongshu.com/explore/62da5eb9000000001101199d', '[减肥不讲李] | ❤ 53 | 💬 71 | ⭐ 38 | 搜索词: 智能灯被坑', NULL, 8.11, 0, '2026-07-13 08:36:37'
FROM categories c WHERE c.code = 'NIGHT_LIGHT'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/62da5eb9000000001101199d');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '灯带的坑还没踩完！', NULL, 'https://www.xiaohongshu.com/explore/6a17c456000000003700d70a', '[装修踩坑的Mario🏠] | ❤ 10 | 💬 18 | ⭐ 2 | 搜索词: 智能灯被坑', NULL, 1.93, 0, '2026-07-13 08:36:37'
FROM categories c WHERE c.code = 'NIGHT_LIGHT'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/6a17c456000000003700d70a');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '避雷柜子灯带触摸开关！', NULL, 'https://www.xiaohongshu.com/explore/6a50d471000000001102e05c', '[兰州智能家居王工] | ❤ 15 | 💬 0 | ⭐ 9 | 搜索词: 智能灯被坑', NULL, 0.26, 0, '2026-07-13 08:36:37'
FROM categories c WHERE c.code = 'NIGHT_LIGHT'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/6a50d471000000001102e05c');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '拯救屁屁❗️❗️打工人必备坐垫✨低至4R', NULL, 'https://www.xiaohongshu.com/explore/631c6d52000000001303a77f', '[郑原里美] | ❤ 25777 | 💬 209 | ⭐ 14411 | 搜索词: 坐垫推荐', NULL, 90.0, 1, '2026-07-13 08:36:37'
...
INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '绝了❗️这坐垫也太厚实了吧', NULL, 'https://www.xiaohongshu.com/explore/62a5e016000000002103a40f', '[麦芽] | ❤ 22793 | 💬 163 | ⭐ 12594 | 搜索词: 坐垫推荐', NULL, 86.3, 1, '2026-07-13 08:36:37'
FROM categories c WHERE c.code = 'SEAT_CUSHION'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/62a5e016000000002103a40f');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '单向滑动坐垫', NULL, 'https://www.xiaohongshu.com/explore/684ad9e40000000012006372', '[轮上人] | ❤ 17400 | 💬 163 | ⭐ 2540 | 搜索词: 坐垫滑走', NULL, 86.3, 1, '2026-07-13 08:36:37'
FROM categories c WHERE c.code = 'SEAT_CUSHION'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/684ad9e40000000012006372');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '海豹屁垫是什么馅儿的呢🤔', NULL, 'https://www.xiaohongshu.com/explore/6984192e000000002200bda2', '[PokiDoki的礼物] | ❤ 10901 | 💬 154 | ⭐ 1780 | 搜索词: 记忆棉坐垫', NULL, 77.65, 1, '2026-07-13 08:36:37'
FROM categories c WHERE c.code = 'SEAT_CUSHION'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/6984192e000000002200bda2');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '后续来了！10w人看过的13r涨价屁垫子平替！！！', NULL, 'https://www.xiaohongshu.com/explore/6835cb3200000000220259bd', '[芋头不爱吃香菜] | ❤ 8463 | 💬 304 | ⭐ 3370 | 搜索词: 办公室坐垫', NULL, 90.0, 1, '2026-07-13 08:36:37'
FROM categories c WHERE c.code = 'SEAT_CUSHION'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/6835cb3200000000220259bd');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '随手po！8💰久坐不塌的屁垫分享！！无广！！！', NULL, 'https://www.xiaohongshu.com/explore/683f00f900000000210187b8', '[饭团] | ❤ 6981 | 💬 220 | ⭐ 4503 | 搜索词: 坐垫哪个好', NULL, 90.0, 1, '2026-07-13 08:36:37'
FROM categories c WHERE c.code = 'SEAT_CUSHION'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/683f00f900000000210187b8');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '椅子坐垫', NULL, 'https://www.xiaohongshu.com/explore/64fd93d0000000001500ac95', '[上午好] | ❤ 6359 | 💬 634 | ⭐ 3944 | 搜索词: 坐垫学生', NULL, 90.0, 1, '2026-07-13 08:36:37'
FROM categories c WHERE c.code = 'SEAT_CUSHION'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/64fd93d0000000001500ac95');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '8💰！！坐了两个月不塌的屁垫反馈来啦！！', NULL, 'https://www.xiaohongshu.com/explore/6899f81e000000002303bec1', '[饭团] | ❤ 6234 | 💬 92 | ⭐ 3591 | 搜索词: 办公坐垫评测', NULL, 79.2, 1, '2026-07-13 08:36:37'
FROM categories c WHERE c.code = 'SEAT_CUSHION'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/6899f81e000000002303bec1');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '考研久坐平价坐垫腰靠推荐(两件不到30！)', NULL, 'https://www.xiaohongshu.com/explore/66176027000000001b00a493', '[小翘] | ❤ 5394 | 💬 293 | ⭐ 3155 | 搜索词: 坐垫推荐', NULL, 90.0, 1, '2026-07-13 08:36:37'
FROM categories c WHERE c.code = 'SEAT_CUSHION'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/66176027000000001b00a493');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '久坐人需要的屁垫', NULL, 'https://www.xiaohongshu.com/explore/64e87ffe0000000010030753', '[大白玩具] | ❤ 5428 | 💬 1115 | ⭐ 1076 | 搜索词: 办公室坐垫', NULL, 73.45, 1, '2026-07-13 08:36:37'
FROM categories c WHERE c.code = 'SEAT_CUSHION'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/64e87ffe0000000010030753');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '亲测300天热敷效果！真的绝了！！！', '亲测300天热敷效果！真的绝了！！！', 'https://www.xiaohongshu.com/explore/6908c567000000000503b171', '[小都耶耶] | ❤ 10006 | 💬 55 | ⭐ 2429 | 搜索词: 肩颈热敷', '[小都耶耶] | ❤ 10006 | 💬 55 | ⭐ 2429 | 搜索词: 肩颈热敷', 75.5, 1, '2026-07-13 09:00:41'
...
INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '舒缓颈椎❣️低头族必看的好物分享', '舒缓颈椎❣️低头族必看的好物分享', 'https://www.xiaohongshu.com/explore/612b5b06000000000102ab52', '[Cecilia宋妍霏] | ❤ 7641 | 💬 171 | ⭐ 3600 | 搜索词: 肩颈热敷', '[Cecilia宋妍霏] | ❤ 7641 | 💬 171 | ⭐ 3600 | 搜索词: 肩颈热敷', 87.1, 1, '2026-07-13 09:00:41'
FROM categories c WHERE c.code = 'SHOULDER_NECK_HEAT_THERAPY'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/612b5b06000000000102ab52');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '谁懂😭，这个29💰热敷♨️枕，绝绝子！', '谁懂😭，这个29💰热敷♨️枕，绝绝子！', 'https://www.xiaohongshu.com/explore/66792ada000000001d014d83', '[唯艾优选生活馆] | ❤ 2880 | 💬 665 | ⭐ 1469 | 搜索词: 颈椎热敷推荐', '[唯艾优选生活馆] | ❤ 2880 | 💬 665 | ⭐ 1469 | 搜索词: 颈椎热敷推荐', 67.16, 1, '2026-07-13 09:00:41'
FROM categories c WHERE c.code = 'SHOULDER_NECK_HEAT_THERAPY'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/66792ada000000001d014d83');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '🆘缓解肩颈疼痛神器！最低10r，岂止一个爽字', '🆘缓解肩颈疼痛神器！最低10r，岂止一个爽字', 'https://www.xiaohongshu.com/explore/6218764a00000000010271ae', '[是JOJO啊] | ❤ 2793 | 💬 78 | ⭐ 2404 | 搜索词: 肩颈热敷', '[是JOJO啊] | ❤ 2793 | 💬 78 | ⭐ 2404 | 搜索词: 肩颈热敷', 65.73, 1, '2026-07-13 09:00:41'
FROM categories c WHERE c.code = 'SHOULDER_NECK_HEAT_THERAPY'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/6218764a00000000010271ae');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '200+颈椎头疗，不如19.9💰的艾草热敷枕❗️', '200+颈椎头疗，不如19.9💰的艾草热敷枕❗️', 'https://www.xiaohongshu.com/explore/674c2d67000000000800738a', '[别吃我血包] | ❤ 3424 | 💬 235 | ⭐ 1411 | 搜索词: 颈椎热敷', '[别吃我血包] | ❤ 3424 | 💬 235 | ⭐ 1411 | 搜索词: 颈椎热敷', 71.88, 1, '2026-07-13 09:00:41'
FROM categories c WHERE c.code = 'SHOULDER_NECK_HEAT_THERAPY'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/674c2d67000000000800738a');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '发现了一个颈椎病热敷的好办法！', '发现了一个颈椎病热敷的好办法！', 'https://www.xiaohongshu.com/explore/6726ea59000000001b02f264', '[多多🐈开心] | ❤ 2453 | 💬 215 | ⭐ 1567 | 搜索词: 办公室肩颈热敷', '[多多🐈开心] | ❤ 2453 | 💬 215 | ⭐ 1567 | 搜索词: 办公室肩颈热敷', 64.12, 1, '2026-07-13 09:00:41'
FROM categories c WHERE c.code = 'SHOULDER_NECK_HEAT_THERAPY'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/6726ea59000000001b02f264');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '无聊中，来安利下各种肩颈贴贴（会更新）', '无聊中，来安利下各种肩颈贴贴（会更新）', 'https://www.xiaohongshu.com/explore/666d76c0000000000e031122', '[JiiiiiiE] | ❤ 1980 | 💬 95 | ⭐ 1247 | 搜索词: 肩颈热敷', '[JiiiiiiE] | ❤ 1980 | 💬 95 | ⭐ 1247 | 搜索词: 肩颈热敷', 44.89, 0, '2026-07-13 09:00:41'
FROM categories c WHERE c.code = 'SHOULDER_NECK_HEAT_THERAPY'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/666d76c0000000000e031122');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '热敷六个小时，肩颈真的不痛了😭｜教师的体态', '热敷六个小时，肩颈真的不痛了😭｜教师的体态', 'https://www.xiaohongshu.com/explore/671a2c09000000002603662a', '[慢慢的一天] | ❤ 1351 | 💬 122 | ⭐ 600 | 搜索词: 睡前颈椎热敷', '[慢慢的一天] | ❤ 1351 | 💬 122 | ⭐ 600 | 搜索词: 睡前颈椎热敷', 33.21, 0, '2026-07-13 09:00:41'
FROM categories c WHERE c.code = 'SHOULDER_NECK_HEAT_THERAPY'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/671a2c09000000002603662a');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '真的离谱！妙界热敷肩颈贴说实话！！！', '真的离谱！妙界热敷肩颈贴说实话！！！', 'https://www.xiaohongshu.com/explore/689fc053000000001d0051d8', '[小雨的肥啾] | ❤ 125 | 💬 0 | ⭐ 69 | 搜索词: 肩颈热敷智商税', '[小雨的肥啾] | ❤ 125 | 💬 0 | ⭐ 69 | 搜索词: 肩颈热敷智商税', 2.11, 0, '2026-07-13 09:00:41'
FROM categories c WHERE c.code = 'SHOULDER_NECK_HEAT_THERAPY'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/689fc053000000001d0051d8');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '肩痛热敷当心越敷越疼', '肩痛热敷当心越敷越疼', 'https://www.xiaohongshu.com/explore/695c7381000000001a01d31a', '[关节医生曹建刚] | ❤ 79 | 💬 3 | ⭐ 66 | 搜索词: 肩颈热敷不好用', '[关节医生曹建刚] | ❤ 79 | 💬 3 | ⭐ 66 | 搜索词: 肩颈热敷不好用', 1.92, 0, '2026-07-13 09:00:41'
FROM categories c WHERE c.code = 'SHOULDER_NECK_HEAT_THERAPY'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/695c7381000000001a01d31a');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'technology', 'social_post', 'xiaohongshu', '【干货】腹直肌分离Tens Care使用说明', NULL, 'https://www.xiaohongshu.com/explore/5c83c501000000000f03efbc', '[丿 、Jasmine] | ❤ 1236 | 💬 224 | ⭐ 2186 | 搜索词: tens贴片', NULL, 59.69, 1, '2026-07-13 06:29:13'
...
INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'technology', 'social_post', 'xiaohongshu', '康复科神器-中频脉冲电', NULL, 'https://www.xiaohongshu.com/explore/67c6d473000000002602dc2f', '[仙霞康复小张] | ❤ 988 | 💬 182 | ⭐ 654 | 搜索词: 电脉冲理疗仪', NULL, 36.25, 0, '2026-07-13 06:29:13'
FROM categories c WHERE c.code = 'TENS_THERAPY'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/67c6d473000000002602dc2f');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'technology', 'social_post', 'xiaohongshu', '针灸脉冲理疗仪', NULL, 'https://www.xiaohongshu.com/explore/65955ae9000000001200472d', '[一朵毒花🌸] | ❤ 296 | 💬 340 | ⭐ 205 | 搜索词: 电脉冲理疗仪', NULL, 25.52, 0, '2026-07-13 06:29:13'
FROM categories c WHERE c.code = 'TENS_THERAPY'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/65955ae9000000001200472d');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'technology', 'social_post', 'xiaohongshu', '神经肌肉电刺激（NMES）贴片位置及目的', NULL, 'https://www.xiaohongshu.com/explore/69b75f06000000002301d9c1', '[康复师手记] | ❤ 419 | 💬 2 | ⭐ 431 | 搜索词: tens贴片寿命', NULL, 9.78, 0, '2026-07-13 06:29:13'
FROM categories c WHERE c.code = 'TENS_THERAPY'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/69b75f06000000002301d9c1');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'users', 'social_post', 'xiaohongshu', '康复训练电疗之功能性电刺激的原理！', NULL, 'https://www.xiaohongshu.com/explore/677773c40000000013003fca', '[雅思Y医疗器械] | ❤ 756 | 💬 129 | ⭐ 450 | 搜索词: tens肩周炎', NULL, 26.09, 0, '2026-07-13 06:29:13'
FROM categories c WHERE c.code = 'TENS_THERAPY'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/677773c40000000013003fca');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '偏头痛人！没招了？先去试试TENS仪器！理疗', NULL, 'https://www.xiaohongshu.com/explore/6a268e1d0000000006037b9c', '[Codie十年失眠努力自救] | ❤ 248 | 💬 77 | ⭐ 324 | 搜索词: tens仪推荐', NULL, 14.23, 0, '2026-07-13 06:29:13'
FROM categories c WHERE c.code = 'TENS_THERAPY'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/6a268e1d0000000006037b9c');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '理疗仪真的会让人有这么大反应？', NULL, 'https://www.xiaohongshu.com/explore/66bb2028000000000d031e12', '[王梓陌] | ❤ 30149 | 💬 954 | ⭐ 3917 | 搜索词: 理疗仪评测', NULL, 90.0, 1, '2026-07-13 06:29:13'
FROM categories c WHERE c.code = 'TENS_THERAPY'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/66bb2028000000000d031e12');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'market', 'social_post', 'xiaohongshu', '智商税之理疗仪？', NULL, 'https://www.xiaohongshu.com/explore/6694de5200000000250179b4', '[蛋仔派对北念] | ❤ 379 | 💬 123 | ⭐ 155 | 搜索词: 理疗仪评测', NULL, 18.03, 0, '2026-07-13 06:29:13'
FROM categories c WHERE c.code = 'TENS_THERAPY'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/6694de5200000000250179b4');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'needs', 'social_post', 'xiaohongshu', '老人保健品、理疗仪防沉迷系统！一招解决~', NULL, 'https://www.xiaohongshu.com/explore/67a7ea6d000000002902a1a4', '[哏工侃智能] | ❤ 454 | 💬 87 | ⭐ 246 | 搜索词: 理疗仪骗局', NULL, 16.31, 0, '2026-07-13 06:29:13'
FROM categories c WHERE c.code = 'TENS_THERAPY'
  AND NOT EXISTS (SELECT 1 FROM hot_links h WHERE h.url = 'https://www.xiaohongshu.com/explore/67a7ea6d000000002902a1a4');

INSERT INTO hot_links (category_id, section_key, link_type, platform, title, title_zh, url, description, description_zh, hotness_score, is_hot, collected_at)
SELECT c.id, 'needs', 'social_post', 'xiaohongshu', '🌟电疗干货一篇搞定｜作用禁忌+操作指南💡', NULL, 'https://www.xiaohongshu.com/explore/68f610fc0000000004017437', '[庄庄-要-安康] | ❤ 842 | 💬 26 | ⭐ 594 | 搜索词: tens副作用', NULL, 18.45, 0, '2026-07-13 06:29:13'
FROM categories c WHERE c.code = 'TENS_THERAPY'
